...
fn test_avnu_swap_collect_fee() {
    ...
    assert_eq!(return_amount_after_fee, 50 - PROTOCOL_FEE, "Balance of from token should decrease");
...
fn test_avnu_swap_collector_balance() {
    ...
    assert_ge!(fees_collector_balance.usdt, PROTOCOL_FEE, "Incorrect collector fee balance");
}
