...
use auto_swappr::interfaces::fibrous_exchange::{IFibrousExchangeDispatcher, IFibrousExchangeDispatcherTrait};
...
fn test_fibrous_swap() {
    ...
    let address_with_funds = contract_address_const::<ADDRESS_WITH_STRK_1>();
        ...
        strk_token
        .approve(
            contract_address_const::<0x00f6f4CF62E3C010E0aC2451cC7807b5eEc19a40b0FaaCd00CCA3914280FDf5a>(), // fibrous
            200000000000000000000
        );
        stop_cheat_caller_address(strk_token.contract_address);


        // comment this down and try to call it directly now 
        start_cheat_caller_address(autoSwappr_dispatcher.contract_address, address_with_funds);
        start_cheat_account_contract_address(contract_address_const::<0x00f6f4CF62E3C010E0aC2451cC7807b5eEc19a40b0FaaCd00CCA3914280FDf5a>(), address_with_funds);
        ...
        // let fibrous = IFibrousExchangeDispatcher { contract_address: contract_address_const::<0x00f6f4CF62E3C010E0aC2451cC7807b5eEc19a40b0FaaCd00CCA3914280FDf5a>() };
        // start_cheat_caller_address(fibrous.contract_address, address_with_funds);
        // start_cheat_account_contract_address(fibrous.contract_address, address_with_funds);
...
//         // comment this down and try to call it directly now 
//         // start_cheat_caller_address(autoSwappr_dispatcher.contract_address, address_with_funds);
//         // start_cheat_account_contract_address(autoSwappr_dispatcher.contract_address, address_with_funds);
//         // autoSwappr_dispatcher
//         //     .fibrous_swap(
//             //         routeParams,
//             //         swapParams,
